...
class TestDecoderOnlyTransformer:
    ...
    def test_smoke(self, input_tokens: jnp.ndarray, model_config: model.ModelConfig):
        """Test a simple forward pass of the model."""
        model = model.DecoderOnlyTransformer(
...
class TestTrainStep:
    ...
    def test_smoke(
        ...
        (loss, _), _ = jax.jit(jax.value_and_grad(model.train_step, has_aux=True))(
